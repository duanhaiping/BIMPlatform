...
namespace BIMPlatform.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See BIMPlatformMigrationsDbContext for migrations.
     */
    ...
    public class BIMPlatformDbContext : AbpDbContext<BIMPlatformDbContext>
    {
        ...
        public BIMPlatformDbContext(DbContextOptions<BIMPlatformDbContext> options)
            : base(options)
        {
