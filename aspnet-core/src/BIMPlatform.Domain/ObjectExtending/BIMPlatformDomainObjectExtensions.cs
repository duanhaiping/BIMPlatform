...
namespace BIMPlatform.ObjectExtending
{
    public static class BIMPlatformDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the BIMPlatformEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
